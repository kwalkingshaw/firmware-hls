...
always begin
 ...
 //#585 bx_in_ProjectionRouter <= bx_in_ProjectionRouter + 1'b1;
end
...
Memory #(
  ...
  .clkb(clk),
  .rstb(1'b0),
  .wea(CM_L3PHIC17to24_dataarray_data_V_wea[a]),
  .addra(CM_L3PHIC17to24_dataarray_data_V_writeaddr[a]),
  .dina(CM_L3PHIC17to24_dataarray_data_V_din[a]),
  .nent_we0(CM_L3PHIC17to24_nentries_0_V_we[a]),
  .nent_i0(CM_L3PHIC17to24_nentries_0_V_din[a]),
  .nent_we1(CM_L3PHIC17to24_nentries_1_V_we[a]),
  .nent_i1(CM_L3PHIC17to24_nentries_1_V_din[a]),
  .enb(CM_L3PHIC17to24_dataarray_data_V_enb[a]),
  .addrb(CM_L3PHIC17to24_dataarray_data_V_readaddr[a]),
  .doutb(CM_L3PHIC17to24_dataarray_data_V_dout[a]),
  .nent_o0(CM_L3PHIC17to24_nentries_0_V_dout[a]),
  .nent_o1(CM_L3PHIC17to24_nentries_1_V_dout[a]),
  .regceb(1'b1)
);
end
endgenerate
...
SectorProcessor SectorProcessor_inst (
  ...
  .CM_L3PHIC17to24_nentries_0_V_we(CM_L3PHIC17to24_nentries_0_V_we),
  .CM_L3PHIC17to24_nentries_0_V_din(CM_L3PHIC17to24_nentries_0_V_din),
  .CM_L3PHIC17to24_nentries_1_V_we(CM_L3PHIC17to24_nentries_1_V_we),
  .CM_L3PHIC17to24_nentries_1_V_din(CM_L3PHIC17to24_nentries_1_V_din),
  .MatchEngine_done(MatchEngine_done)
);
