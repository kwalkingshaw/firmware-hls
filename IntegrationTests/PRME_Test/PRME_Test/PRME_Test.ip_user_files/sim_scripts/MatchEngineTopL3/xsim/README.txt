...
#
# Generated by export_simulation on Wed Feb 05 16:15:15 EST 2020
#
################################################################################
...
'-reset_run' switch to the './MatchEngineTopL3.sh' script.

./MatchEngineTopL3.sh -reset_run
...
./MatchEngineTopL3.sh -noclean_files

For more information on the script, please type './MatchEngineTopL3.sh -help'.
